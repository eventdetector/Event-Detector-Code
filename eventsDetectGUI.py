...
class Ui_MainWindow(object):
    def upload_abf_file(self):
        file_dialog = QFileDialog()
        file_path, _ = file_dialog.getOpenFileName(self.centralwidget, "Select ABF File")
    ...
    def setupUi(self, MainWindow):
        ...
        # self.pushButton_showABF.setObjectName("pushButton_showABF")
        # self.pushButton_showABF.clicked.connect(self.show_abf_file)
        # self.pushButton_showABF.setText("Show ABF File")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_startCoeff.setText(_translate("MainWindow", "thresholdCoeff"))
